...
<div class="wrapper">
	...
	<div>
        <label>
            Party Size:<br /><input type="number" id="party" min="1" max="12"><br>
        </label>
		<label>
            Date & Time:<br/><input type="datetime-local" id="time"><br>
        </label>
        <label>
	...
	<div>	
		<label>
			Requests:<br /><textarea name="Comments" cols="36" rows="4" placeholder="Please list any dietary restrictions or allergies" tabindex="30"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
